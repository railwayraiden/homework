...
export interface Mutation {
	...
	sendBountyWonEmail: Scalars["Boolean"];
	...
	sendCommunityWelcomeEmail: Scalars["Boolean"];
	/** Send a new bounty question email */
	sendNewBountyEmail: Scalars["Boolean"];
	/** Send a question moved to bounty email */
	sendQuestionMovedToBountyEmail: Scalars["Boolean"];
...
export interface ReissuedInvoice {
	id: Scalars["ID"];
	originalInvoiceId: Scalars["String"];
	reissuedInvoiceId: Scalars["String"] | null;
	workspace: Workspace;
...
export interface MutationGenqlSelection {
	...
	/** Creates a new custom domain. */
	customDomainCreate?: CustomDomainGenqlSelection & {
		__args: { input: CustomDomainCreateInput };
	};
	/** Deletes a custom domain. */
	...
	/** Create services and volumes from docker compose */
	dockerComposeImport?: DockerComposeImportGenqlSelection & {
		__args: {
			environmentId: Scalars["String"];
			projectId: Scalars["String"];
	...
	egressGatewayAssociationsClear?: {
		__args: { input: EgressGatewayServiceTargetInput };
	};
	/** Change the User's account email if there is a valid change email request. */
	...
	/** Creates a new environment. */
	environmentCreate?: EnvironmentGenqlSelection & {
		__args: { input: EnvironmentCreateInput };
	};
	/** Deletes an environment. */
	...
	environmentTriggersDeploy?: {
		__args: { input: EnvironmentTriggersDeployInput };
	};
	/** Agree to the fair use policy for the currently authenticated user */
	...
	/** Create an integration for a project */
	integrationCreate?: IntegrationGenqlSelection & {
		__args: { input: IntegrationCreateInput };
	};
	/** Delete an integration for a project */
	...
	/** Join a project using an invite code */
	inviteCodeUse?: ProjectGenqlSelection & {
	...
	observabilityDashboardCreate?: {
		__args: { input: ObservabilityDashboardCreateInput };
	};
	/** Reset an observability dashboard to default dashboard items */
	...
	/** Deletes a plugin. */
	pluginDelete?: {
		__args: { environmentId?: Scalars["String"] | null; id: Scalars["String"] };
	};
	/** Reset envs and container for a plugin in an environment */
	...
	preferenceOverridesCreateUpdate?: {
		__args: { input: PreferenceOverridesCreateUpdateData };
	};
	/** Destroy preferences overrides for a specific resource belonging to a user */
	preferenceOverridesDestroyForResource?: {
		__args: { input: PreferenceOverridesDestroyData };
	};
	/** Update the email preferences for a user */
	preferencesUpdate?: PreferencesGenqlSelection & {
		__args: { input: PreferencesUpdateData };
	};
	/** Create or get a private network. */
	...
	/** Claims a project. */
	projectClaim?: ProjectGenqlSelection & {
		__args: { id: Scalars["String"]; workspaceId: Scalars["String"] };
	};
	/** Creates a new project. */
	projectCreate?: ProjectGenqlSelection & {
	...
	/** Invite a user by email to a project */
	projectInviteUser?: {
		__args: { id: Scalars["String"]; input: ProjectInviteUserInput };
	};
	/** Leave project as currently authenticated user */
	...
	projectTransferToTeam?: {
		__args: { id: Scalars["String"]; input: ProjectTransferToTeamInput };
	};
	/** Updates a project. */
	...
	/** Updates the ReferralInfo for the authenticated user. */
	referralInfoUpdate?: ReferralInfoGenqlSelection & {
		__args: { input: ReferralInfoUpdateInput };
	};
	/** Send a notification email to user when bounty is won */
	sendBountyWonEmail?: { __args: { input: SendBountyWonEmailInput } };
	/** Send a community thread notification email */
	...
	sendCommunityWelcomeEmail?: {
		__args: { input: SendCommunityWelcomeEmailInput };
	};
	/** Send a new bounty question email */
	sendNewBountyEmail?: { __args: { input: SendNewBountyEmailInput } };
	/** Send a question moved to bounty email */
	sendQuestionMovedToBountyEmail?: {
		__args: { input: SendQuestionMovedToBountyEmailInput };
	};
	/** Connect a service to a source */
	...
	/** Creates a new service. */
	serviceCreate?: ServiceGenqlSelection & {
	...
	/** Disconnect a service from a repo */
	serviceDisconnect?: ServiceGenqlSelection & {
		__args: { id: Scalars["String"] };
	};
	/** Creates a new service domain. */
	 ...
	 * Duplicate a service, including its configuration, variables, and volumes.
	 */
	serviceDuplicate?: ServiceGenqlSelection & {
	...
	serviceFeatureFlagRemove?: {
		__args: { input: ServiceFeatureFlagToggleInput };
	};
	/** Deploy a service instance */
	...
	serviceInstanceLimitsUpdate?: {
		__args: { input: ServiceInstanceLimitsUpdateInput };
	};
	/** Redeploy a service instance */
	...
	/** Remove the upstream URL from all service instances for this service */
	serviceRemoveUpstreamUrl?: ServiceGenqlSelection & {
		__args: { id: Scalars["String"] };
	};
	/** Updates a service. */
	 ...
	 * Creates a new TCP proxy for a service instance.
	 */
	tcpProxyCreate?: TCPProxyGenqlSelection & {
		__args: { input: TCPProxyCreateInput };
	};
	/** Deletes a TCP proxy by id */
	...
	teamInviteCodeCreate?: {
		__args: { id: Scalars["String"]; input: TeamInviteCodeCreateInput };
	};
	/** Use an invite code to join a team */
	teamInviteCodeUse?: TeamGenqlSelection & {
		__args: { code: Scalars["String"] };
	};
	/** Leave a team */
	...
	/** Invite a user by email to a team */
	teamUserInvite?: {
		__args: { id: Scalars["String"]; input: TeamUserInviteInput };
	};
	/** Remove a user from a team */
	teamUserRemove?: {
		__args: { id: Scalars["String"]; input: TeamUserRemoveInput };
	};
	/** Duplicates an existing template */
	templateClone?: TemplateGenqlSelection & {
		__args: { input: TemplateCloneInput };
	};
	/** Deletes a template. */
	templateDelete?: {
		__args: { id: Scalars["String"]; input: TemplateDeleteInput };
	};
	/**
	 * @deprecated Deprecated in favor of templateDeployV2
	 * Deploys a template.
	...
	/** Generate a template for a project */
	templateGenerate?: TemplateGenqlSelection & {
		__args: { input: TemplateGenerateInput };
	};
	/** Nullify the community thread slug for a template, if one is found with the provided slug */
	templateMaybeUnsetCommunityThreadSlug?: {
		__args: { communityThreadSlug: Scalars["String"] };
	};
	/** Publishes a template. */
	...
	templateServiceSourceEject?: {
		__args: { input: TemplateServiceSourceEjectInput };
	};
	/** Unpublishes a template. */
	...
	variableCollectionUpsert?: {
		__args: { input: VariableCollectionUpsertInput };
	};
	/** Deletes a variable. */
	...
	/** Create a webhook on a project */
	webhookCreate?: ProjectWebhookGenqlSelection & {
		__args: { input: WebhookCreateInput };
	};
	/** Delete a webhook from a project */
	...
	/** Update a workspace by id */
	workspaceUpdate?: {
		__args: { id: Scalars["String"]; input: WorkspaceUpdateInput };
	};
	/** Generate a Slack channel for a workspace */
...
export interface NodeGenqlSelection {
	...
	on_ReissuedInvoice?: ReissuedInvoiceGenqlSelection;
...
export interface QueryGenqlSelection {
	...
	/** Get the workspaces the user doesn't belong to, but needs access (like when invited to a project) */
	externalWorkspaces?: ExternalWorkspaceGenqlSelection & {
		__args?: { projectId?: Scalars["String"] | null };
	};
	/** Get information about a specific function runtime */
	functionRuntime?: FunctionRuntimeGenqlSelection & {
		__args: { name: FunctionRuntimeName };
	};
	/** List available function runtimes */
	...
	/** Get an invite code by the code */
	inviteCode?: InviteCodeGenqlSelection & {
		__args: { code: Scalars["String"] };
	};
	/** Gets the authenticated user. */
	...
	preferences?: PreferencesGenqlSelection & {
		__args?: { token?: Scalars["String"] | null };
	};
	/** Get a private network endpoint for a service instance. */
	...
	/** Get invitations for a project */
	projectInvitations?: ProjectInvitationGenqlSelection & {
		__args: { id: Scalars["String"] };
	};
	/** Get an invite code for a project for a specifc role */
	...
	/** Gets users who belong to a project along with their role */
	projectMembers?: ProjectMemberGenqlSelection & {
	...
	referralInfo?: ReferralInfoGenqlSelection & {
		__args: { workspaceId: Scalars["String"] };
	};
	/** List available regions */
	...
	resourceAccess?: ResourceAccessGenqlSelection & {
		__args: { explicitResourceOwner: ExplicitOwnerInput };
	};
	/** Get a service by ID */
	...
	/** Get the source template for a project. */
	templateSourceForProject?: TemplateGenqlSelection & {
		__args: { projectId: Scalars["String"] };
	};
	/** Get all published templates. */
	...
	/** Get the public profile for a user */
	userProfile?: UserProfileResponseGenqlSelection & {
		__args: { username: Scalars["String"] };
	};
	/**
	 * @deprecated Users don't have personal templates anymore, they belong to their team now
	 * Get all templates for the current user.
	...
	/** Get a single volume instance by id */
	volumeInstance?: VolumeInstanceGenqlSelection & {
		__args: { id: Scalars["String"] };
	};
	/** List backups of a volume instance */
	...
	/** Gets the status of a workflow */
	workflowStatus?: WorkflowResultGenqlSelection & {
		__args: { workflowId: Scalars["String"] };
	};
	/** Get the workspace */
	workspace?: WorkspaceGenqlSelection & {
		__args: { workspaceId: Scalars["String"] };
...
export interface ReissuedInvoiceGenqlSelection {
	id?: boolean | number;
	originalInvoiceId?: boolean | number;
	reissuedInvoiceId?: boolean | number;
	workspace?: WorkspaceGenqlSelection;
...
export interface SendBountyWonEmailInput {
	bountyAmount: Scalars["Float"];
...
export interface SendCommunityWelcomeEmailInput {
	userId: Scalars["String"];
}

export interface SendNewBountyEmailInput {
	threadTitle: Scalars["String"];
	threadUrl: Scalars["String"];
	userIds: Scalars["String"][];
}

export interface SendQuestionMovedToBountyEmailInput {
	threadTitle: Scalars["String"];
	threadUrl: Scalars["String"];
	userId: Scalars["String"];
}
...
export interface SubscriptionGenqlSelection {
	...
	deployment?: DeploymentGenqlSelection & { __args: { id: Scalars["String"] } };
	/** Subscribe to deployment events for a specific deployment */
	deploymentEvents?: DeploymentEventGenqlSelection & {
		__args: { id: Scalars["String"] };
	};
	/** Subscribe to deployment instance executions for a specific deployment */
	...
	/** Subscribe to migration progress updates for a volume */
	replicationProgress?: VolumeReplicationProgressUpdateGenqlSelection & {
		__args: { volumeInstanceId: Scalars["String"] };
	};
	__typename?: boolean | number;
	__scalar?: boolean | number;
}
...
export const isBanReasonHistory = (
	obj?: { __typename?: any } | null,
): obj is BanReasonHistory => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isBanReasonHistory"');
...
export const isBillingPeriod = (
	obj?: { __typename?: any } | null,
): obj is BillingPeriod => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isBillingPeriod"');
...
export const isCertificatePublicData = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isCertificatePublicData"');
	return CertificatePublicData_possibleTypes.includes(obj.__typename);
};

const CnameCheck_possibleTypes: string[] = ["CnameCheck"];
export const isCnameCheck = (
	obj?: { __typename?: any } | null,
): obj is CnameCheck => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isCnameCheck"');
...
export const isContainer = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isContainer"');
...
export const isCustomDomain = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isCustomDomain"');
...
export const isCustomDomainStatus = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isCustomDomainStatus"');
...
const CustomerCreditsConnection_possibleTypes: string[] = [
...
export const isCustomerCreditsConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isCustomerCreditsConnection"');
	return CustomerCreditsConnection_possibleTypes.includes(obj.__typename);
};

const CustomerCreditsConnectionEdge_possibleTypes: string[] = [
...
export const isCustomerInvoice = (
	obj?: { __typename?: any } | null,
): obj is CustomerInvoice => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isCustomerInvoice"');
...
export const isCustomerSubscription = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isCustomerSubscription"');
	return CustomerSubscription_possibleTypes.includes(obj.__typename);
};

const DNSRecords_possibleTypes: string[] = ["DNSRecords"];
export const isDNSRecords = (
	obj?: { __typename?: any } | null,
): obj is DNSRecords => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isDNSRecords"');
...
export const isDeployment = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isDeployment"');
	return Deployment_possibleTypes.includes(obj.__typename);
};

const DeploymentCreator_possibleTypes: string[] = ["DeploymentCreator"];
export const isDeploymentCreator = (
	obj?: { __typename?: any } | null,
): obj is DeploymentCreator => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isDeploymentCreator"');
	return DeploymentCreator_possibleTypes.includes(obj.__typename);
};

const DeploymentDeploymentInstance_possibleTypes: string[] = [
	"DeploymentDeploymentInstance",
];
export const isDeploymentDeploymentInstance = (
	obj?: { __typename?: any } | null,
): obj is DeploymentDeploymentInstance => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isDeploymentDeploymentInstance"');
...
export const isDeploymentEvent = (
	obj?: { __typename?: any } | null,
): obj is DeploymentEvent => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isDeploymentEvent"');
	return DeploymentEvent_possibleTypes.includes(obj.__typename);
};

const DeploymentEventPayload_possibleTypes: string[] = [
...
export const isDeploymentEventPayload = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isDeploymentEventPayload"');
	return DeploymentEventPayload_possibleTypes.includes(obj.__typename);
};

const DeploymentInstanceExecution_possibleTypes: string[] = [
	"DeploymentInstanceExecution",
];
...
export const isDeploymentSnapshot = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isDeploymentSnapshot"');
...
export const isDeploymentSocket = (
	obj?: { __typename?: any } | null,
): obj is DeploymentSocket => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isDeploymentSocket"');
...
export const isDeploymentTrigger = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isDeploymentTrigger"');
...
export const isDockerComposeImport = (
	obj?: { __typename?: any } | null,
): obj is DockerComposeImport => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isDockerComposeImport"');
...
export const isDomainAvailable = (
	obj?: { __typename?: any } | null,
): obj is DomainAvailable => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isDomainAvailable"');
	return DomainAvailable_possibleTypes.includes(obj.__typename);
};

const DomainWithStatus_possibleTypes: string[] = ["DomainWithStatus"];
export const isDomainWithStatus = (
	obj?: { __typename?: any } | null,
): obj is DomainWithStatus => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isDomainWithStatus"');
	return DomainWithStatus_possibleTypes.includes(obj.__typename);
};

const EgressGateway_possibleTypes: string[] = ["EgressGateway"];
export const isEgressGateway = (
	obj?: { __typename?: any } | null,
): obj is EgressGateway => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isEgressGateway"');
...
export const isEnvironment = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isEnvironment"');
...
export const isEnvironmentDeploymentTriggersConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isEnvironmentDeploymentTriggersConnection"',
		);
	return EnvironmentDeploymentTriggersConnection_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isEnvironmentDeploymentTriggersConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isEnvironmentDeploymentTriggersConnectionEdge"',
		);
	return EnvironmentDeploymentTriggersConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isEnvironmentDeploymentsConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isEnvironmentDeploymentsConnection"',
		);
...
export const isEnvironmentDeploymentsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isEnvironmentDeploymentsConnectionEdge"',
		);
	return EnvironmentDeploymentsConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};

const EnvironmentMeta_possibleTypes: string[] = ["EnvironmentMeta"];
export const isEnvironmentMeta = (
	obj?: { __typename?: any } | null,
): obj is EnvironmentMeta => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isEnvironmentMeta"');
...
export const isEnvironmentServiceInstancesConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isEnvironmentServiceInstancesConnection"',
		);
	return EnvironmentServiceInstancesConnection_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isEnvironmentServiceInstancesConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isEnvironmentServiceInstancesConnectionEdge"',
		);
	return EnvironmentServiceInstancesConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};

const EnvironmentVariablesConnection_possibleTypes: string[] = [
...
export const isEnvironmentVariablesConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isEnvironmentVariablesConnection"',
		);
...
export const isEnvironmentVariablesConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isEnvironmentVariablesConnectionEdge"',
		);
	return EnvironmentVariablesConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isEnvironmentVolumeInstancesConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isEnvironmentVolumeInstancesConnection"',
		);
	return EnvironmentVolumeInstancesConnection_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isEnvironmentVolumeInstancesConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isEnvironmentVolumeInstancesConnectionEdge"',
		);
	return EnvironmentVolumeInstancesConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};

const EstimatedUsage_possibleTypes: string[] = ["EstimatedUsage"];
export const isEstimatedUsage = (
	obj?: { __typename?: any } | null,
): obj is EstimatedUsage => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isEstimatedUsage"');
...
export const isExternalWorkspace = (
	obj?: { __typename?: any } | null,
): obj is ExternalWorkspace => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isExternalWorkspace"');
	return ExternalWorkspace_possibleTypes.includes(obj.__typename);
};

const FunctionRuntime_possibleTypes: string[] = ["FunctionRuntime"];
export const isFunctionRuntime = (
	obj?: { __typename?: any } | null,
): obj is FunctionRuntime => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isFunctionRuntime"');
	return FunctionRuntime_possibleTypes.includes(obj.__typename);
};

const FunctionRuntimeVersion_possibleTypes: string[] = [
	"FunctionRuntimeVersion",
];
export const isFunctionRuntimeVersion = (
	obj?: { __typename?: any } | null,
): obj is FunctionRuntimeVersion => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isFunctionRuntimeVersion"');
	return FunctionRuntimeVersion_possibleTypes.includes(obj.__typename);
};

const GitHubAccess_possibleTypes: string[] = ["GitHubAccess"];
export const isGitHubAccess = (
	obj?: { __typename?: any } | null,
): obj is GitHubAccess => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isGitHubAccess"');
	return GitHubAccess_possibleTypes.includes(obj.__typename);
};

const GitHubBranch_possibleTypes: string[] = ["GitHubBranch"];
export const isGitHubBranch = (
	obj?: { __typename?: any } | null,
): obj is GitHubBranch => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isGitHubBranch"');
...
export const isGitHubRepo = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isGitHubRepo"');
	return GitHubRepo_possibleTypes.includes(obj.__typename);
};

const GitHubRepoWithoutInstallation_possibleTypes: string[] = [
...
export const isHerokuApp = (
	obj?: { __typename?: any } | null,
): obj is HerokuApp => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isHerokuApp"');
	return HerokuApp_possibleTypes.includes(obj.__typename);
};

const HttpLog_possibleTypes: string[] = ["HttpLog"];
export const isHttpLog = (
	obj?: { __typename?: any } | null,
): obj is HttpLog => {
...
export const isIntegration = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isIntegration"');
	return Integration_possibleTypes.includes(obj.__typename);
};

const IntegrationAuth_possibleTypes: string[] = ["IntegrationAuth"];
export const isIntegrationAuth = (
	obj?: { __typename?: any } | null,
): obj is IntegrationAuth => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isIntegrationAuth"');
...
export const isIntegrationAuthIntegrationsConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isIntegrationAuthIntegrationsConnection"',
		);
	return IntegrationAuthIntegrationsConnection_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isIntegrationAuthIntegrationsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isIntegrationAuthIntegrationsConnectionEdge"',
		);
	return IntegrationAuthIntegrationsConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};

const InviteCode_possibleTypes: string[] = ["InviteCode"];
export const isInviteCode = (
	obj?: { __typename?: any } | null,
): obj is InviteCode => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isInviteCode"');
...
export const isLogAttribute = (
	obj?: { __typename?: any } | null,
): obj is LogAttribute => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isLogAttribute"');
	return LogAttribute_possibleTypes.includes(obj.__typename);
};

const LogTags_possibleTypes: string[] = ["LogTags"];
export const isLogTags = (
	obj?: { __typename?: any } | null,
): obj is LogTags => {
...
export const isMaintenance = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isMaintenance"');
...
export const isMetricTags = (
	obj?: { __typename?: any } | null,
): obj is MetricTags => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isMetricTags"');
	return MetricTags_possibleTypes.includes(obj.__typename);
};

const MetricsResult_possibleTypes: string[] = ["MetricsResult"];
export const isMetricsResult = (
	obj?: { __typename?: any } | null,
): obj is MetricsResult => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isMetricsResult"');
...
const ObservabilityDashboard_possibleTypes: string[] = [
	"ObservabilityDashboard",
];
export const isObservabilityDashboard = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isObservabilityDashboard"');
	return ObservabilityDashboard_possibleTypes.includes(obj.__typename);
};

const ObservabilityDashboardItem_possibleTypes: string[] = [
	"ObservabilityDashboardItem",
];
export const isObservabilityDashboardItem = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isObservabilityDashboardItem"');
...
export const isObservabilityDashboardItemConfig = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isObservabilityDashboardItemConfig"',
		);
...
export const isObservabilityDashboardItemInstance = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isObservabilityDashboardItemInstance"',
		);
	return ObservabilityDashboardItemInstance_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isPaymentMethod = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isPaymentMethod"');
...
export const isPaymentMethodCard = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isPaymentMethodCard"');
...
export const isPlanLimitOverride = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isPlanLimitOverride"');
	return PlanLimitOverride_possibleTypes.includes(obj.__typename);
};

const PlatformStatus_possibleTypes: string[] = ["PlatformStatus"];
export const isPlatformStatus = (
	obj?: { __typename?: any } | null,
): obj is PlatformStatus => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isPlatformStatus"');
...
const PluginContainersConnection_possibleTypes: string[] = [
...
export const isPluginContainersConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isPluginContainersConnection"');
	return PluginContainersConnection_possibleTypes.includes(obj.__typename);
};

const PluginContainersConnectionEdge_possibleTypes: string[] = [
...
export const isPluginContainersConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isPluginContainersConnectionEdge"',
		);
	return PluginContainersConnectionEdge_possibleTypes.includes(obj.__typename);
};

const PluginVariablesConnection_possibleTypes: string[] = [
...
export const isPluginVariablesConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isPluginVariablesConnection"');
	return PluginVariablesConnection_possibleTypes.includes(obj.__typename);
};

const PluginVariablesConnectionEdge_possibleTypes: string[] = [
...
export const isPreferenceOverride = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isPreferenceOverride"');
...
export const isPreferences = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isPreferences"');
...
export const isPrivateNetwork = (
	obj?: { __typename?: any } | null,
): obj is PrivateNetwork => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isPrivateNetwork"');
	return PrivateNetwork_possibleTypes.includes(obj.__typename);
};

const PrivateNetworkEndpoint_possibleTypes: string[] = [
...
export const isPrivateNetworkEndpoint = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isPrivateNetworkEndpoint"');
...
export const isProjectDeploymentTriggersConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isProjectDeploymentTriggersConnection"',
		);
	return ProjectDeploymentTriggersConnection_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isProjectDeploymentTriggersConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isProjectDeploymentTriggersConnectionEdge"',
		);
	return ProjectDeploymentTriggersConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};

const ProjectDeploymentsConnection_possibleTypes: string[] = [
...
export const isProjectDeploymentsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isProjectDeploymentsConnectionEdge"',
		);
	return ProjectDeploymentsConnectionEdge_possibleTypes.includes(obj.__typename);
};

const ProjectEnvironmentsConnection_possibleTypes: string[] = [
...
export const isProjectEnvironmentsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isProjectEnvironmentsConnectionEdge"',
		);
	return ProjectEnvironmentsConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};

const ProjectGroupsConnection_possibleTypes: string[] = [
...
export const isProjectGroupsConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isProjectGroupsConnection"');
	return ProjectGroupsConnection_possibleTypes.includes(obj.__typename);
};

const ProjectGroupsConnectionEdge_possibleTypes: string[] = [
...
export const isProjectInvitation = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isProjectInvitation"');
	return ProjectInvitation_possibleTypes.includes(obj.__typename);
};

const ProjectInvitationInviter_possibleTypes: string[] = [
...
export const isProjectInvitationInviter = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isProjectInvitationInviter"');
...
export const isProjectMember = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isProjectMember"');
...
export const isProjectPermission = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isProjectPermission"');
	return ProjectPermission_possibleTypes.includes(obj.__typename);
};

const ProjectPluginsConnection_possibleTypes: string[] = [
...
export const isProjectPluginsConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isProjectPluginsConnection"');
	return ProjectPluginsConnection_possibleTypes.includes(obj.__typename);
};

const ProjectPluginsConnectionEdge_possibleTypes: string[] = [
...
export const isProjectProjectPermissionsConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isProjectProjectPermissionsConnection"',
		);
	return ProjectProjectPermissionsConnection_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isProjectProjectPermissionsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isProjectProjectPermissionsConnectionEdge"',
		);
	return ProjectProjectPermissionsConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isProjectResourceAccess = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isProjectResourceAccess"');
	return ProjectResourceAccess_possibleTypes.includes(obj.__typename);
};

const ProjectServicesConnection_possibleTypes: string[] = [
...
export const isProjectServicesConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isProjectServicesConnection"');
	return ProjectServicesConnection_possibleTypes.includes(obj.__typename);
};

const ProjectServicesConnectionEdge_possibleTypes: string[] = [
...
export const isProjectToken = (
	obj?: { __typename?: any } | null,
): obj is ProjectToken => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isProjectToken"');
	return ProjectToken_possibleTypes.includes(obj.__typename);
};

const ProjectVolumesConnection_possibleTypes: string[] = [
...
export const isProjectVolumesConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isProjectVolumesConnection"');
	return ProjectVolumesConnection_possibleTypes.includes(obj.__typename);
};

const ProjectVolumesConnectionEdge_possibleTypes: string[] = [
...
export const isProjectWebhook = (
	obj?: { __typename?: any } | null,
): obj is ProjectWebhook => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isProjectWebhook"');
	return ProjectWebhook_possibleTypes.includes(obj.__typename);
};

const ProjectWebhooksConnection_possibleTypes: string[] = [
...
export const isProjectWebhooksConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isProjectWebhooksConnection"');
	return ProjectWebhooksConnection_possibleTypes.includes(obj.__typename);
};

const ProjectWebhooksConnectionEdge_possibleTypes: string[] = [
...
export const isProviderAuth = (
	obj?: { __typename?: any } | null,
): obj is ProviderAuth => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isProviderAuth"');
	return ProviderAuth_possibleTypes.includes(obj.__typename);
};

const PublicProjectInformation_possibleTypes: string[] = [
...
export const isPublicProjectInformation = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isPublicProjectInformation"');
	return PublicProjectInformation_possibleTypes.includes(obj.__typename);
};

const PublicProjectInvitation_possibleTypes: string[] = [
	"InviteCode",
	"ProjectInvitation",
];
export const isPublicProjectInvitation = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isPublicProjectInvitation"');
	return PublicProjectInvitation_possibleTypes.includes(obj.__typename);
};

const PublicStats_possibleTypes: string[] = ["PublicStats"];
export const isPublicStats = (
	obj?: { __typename?: any } | null,
): obj is PublicStats => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isPublicStats"');
...
const QueryApiTokensConnection_possibleTypes: string[] = [
...
export const isQueryApiTokensConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isQueryApiTokensConnection"');
	return QueryApiTokensConnection_possibleTypes.includes(obj.__typename);
};

const QueryApiTokensConnectionEdge_possibleTypes: string[] = [
...
const QueryDeploymentEventsConnection_possibleTypes: string[] = [
...
export const isQueryDeploymentEventsConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryDeploymentEventsConnection"',
		);
...
export const isQueryDeploymentEventsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryDeploymentEventsConnectionEdge"',
		);
	return QueryDeploymentEventsConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isQueryDeploymentInstanceExecutionsConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryDeploymentInstanceExecutionsConnection"',
		);
	return QueryDeploymentInstanceExecutionsConnection_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isQueryDeploymentInstanceExecutionsConnectionEdge = (
	...
	return QueryDeploymentInstanceExecutionsConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isQueryDeploymentTriggersConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryDeploymentTriggersConnection"',
		);
	return QueryDeploymentTriggersConnection_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isQueryDeploymentTriggersConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryDeploymentTriggersConnectionEdge"',
		);
	return QueryDeploymentTriggersConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};

const QueryDeploymentsConnection_possibleTypes: string[] = [
...
export const isQueryDeploymentsConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isQueryDeploymentsConnection"');
	return QueryDeploymentsConnection_possibleTypes.includes(obj.__typename);
};

const QueryDeploymentsConnectionEdge_possibleTypes: string[] = [
...
export const isQueryDeploymentsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryDeploymentsConnectionEdge"',
		);
...
export const isQueryEnvironmentPatchesConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryEnvironmentPatchesConnection"',
		);
	return QueryEnvironmentPatchesConnection_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isQueryEnvironmentPatchesConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryEnvironmentPatchesConnectionEdge"',
		);
	return QueryEnvironmentPatchesConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};

const QueryEnvironmentsConnection_possibleTypes: string[] = [
...
const QueryEnvironmentsConnectionEdge_possibleTypes: string[] = [
...
export const isQueryEnvironmentsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryEnvironmentsConnectionEdge"',
		);
...
export const isQueryEventsConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isQueryEventsConnection"');
	return QueryEventsConnection_possibleTypes.includes(obj.__typename);
};

const QueryEventsConnectionEdge_possibleTypes: string[] = [
...
export const isQueryEventsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isQueryEventsConnectionEdge"');
	return QueryEventsConnectionEdge_possibleTypes.includes(obj.__typename);
};

const QueryIntegrationAuthsConnection_possibleTypes: string[] = [
...
export const isQueryIntegrationAuthsConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryIntegrationAuthsConnection"',
		);
...
export const isQueryIntegrationAuthsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryIntegrationAuthsConnectionEdge"',
		);
	return QueryIntegrationAuthsConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};

const QueryIntegrationsConnection_possibleTypes: string[] = [
...
const QueryIntegrationsConnectionEdge_possibleTypes: string[] = [
...
export const isQueryIntegrationsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryIntegrationsConnectionEdge"',
		);
...
export const isQueryObservabilityDashboardsConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryObservabilityDashboardsConnection"',
		);
	return QueryObservabilityDashboardsConnection_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isQueryObservabilityDashboardsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryObservabilityDashboardsConnectionEdge"',
		);
	return QueryObservabilityDashboardsConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};

const QueryProjectTokensConnection_possibleTypes: string[] = [
...
export const isQueryProjectTokensConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryProjectTokensConnectionEdge"',
		);
	return QueryProjectTokensConnectionEdge_possibleTypes.includes(obj.__typename);
};

const QueryProjectsConnection_possibleTypes: string[] = [
...
export const isQueryProjectsConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isQueryProjectsConnection"');
	return QueryProjectsConnection_possibleTypes.includes(obj.__typename);
};

const QueryProjectsConnectionEdge_possibleTypes: string[] = [
...
const QuerySessionsConnection_possibleTypes: string[] = [
...
export const isQuerySessionsConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isQuerySessionsConnection"');
	return QuerySessionsConnection_possibleTypes.includes(obj.__typename);
};

const QuerySessionsConnectionEdge_possibleTypes: string[] = [
...
const QueryTeamTemplatesConnection_possibleTypes: string[] = [
...
export const isQueryTeamTemplatesConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryTeamTemplatesConnectionEdge"',
		);
...
export const isQueryTeamTrustedDomainsConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryTeamTrustedDomainsConnection"',
		);
	return QueryTeamTrustedDomainsConnection_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isQueryTeamTrustedDomainsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryTeamTrustedDomainsConnectionEdge"',
		);
	return QueryTeamTrustedDomainsConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};

const QueryTemplatesConnection_possibleTypes: string[] = [
...
export const isQueryTemplatesConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isQueryTemplatesConnection"');
	return QueryTemplatesConnection_possibleTypes.includes(obj.__typename);
};

const QueryTemplatesConnectionEdge_possibleTypes: string[] = [
...
const QueryUserTemplatesConnection_possibleTypes: string[] = [
...
export const isQueryUserTemplatesConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isQueryUserTemplatesConnectionEdge"',
		);
	return QueryUserTemplatesConnectionEdge_possibleTypes.includes(obj.__typename);
};

const QueryWebhooksConnection_possibleTypes: string[] = [
...
export const isQueryWebhooksConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isQueryWebhooksConnection"');
	return QueryWebhooksConnection_possibleTypes.includes(obj.__typename);
};

const QueryWebhooksConnectionEdge_possibleTypes: string[] = [
...
export const isRecoveryCodes = (
	obj?: { __typename?: any } | null,
): obj is RecoveryCodes => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isRecoveryCodes"');
	return RecoveryCodes_possibleTypes.includes(obj.__typename);
};

const ReferralInfo_possibleTypes: string[] = ["ReferralInfo"];
export const isReferralInfo = (
	obj?: { __typename?: any } | null,
): obj is ReferralInfo => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isReferralInfo"');
	return ReferralInfo_possibleTypes.includes(obj.__typename);
};

const ReferralStats_possibleTypes: string[] = ["ReferralStats"];
export const isReferralStats = (
	obj?: { __typename?: any } | null,
): obj is ReferralStats => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isReferralStats"');
	return ReferralStats_possibleTypes.includes(obj.__typename);
};

const ReferralUser_possibleTypes: string[] = ["ReferralUser"];
export const isReferralUser = (
	obj?: { __typename?: any } | null,
): obj is ReferralUser => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isReferralUser"');
	return ReferralUser_possibleTypes.includes(obj.__typename);
};

const RefundRequest_possibleTypes: string[] = ["RefundRequest"];
export const isRefundRequest = (
	obj?: { __typename?: any } | null,
): obj is RefundRequest => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isRefundRequest"');
...
const RegionDeploymentConstraints_possibleTypes: string[] = [
...
const ReissuedInvoice_possibleTypes: string[] = ["ReissuedInvoice"];
export const isReissuedInvoice = (
	obj?: { __typename?: any } | null,
): obj is ReissuedInvoice => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isReissuedInvoice"');
	return ReissuedInvoice_possibleTypes.includes(obj.__typename);
};

const ResourceAccess_possibleTypes: string[] = ["ResourceAccess"];
export const isResourceAccess = (
	obj?: { __typename?: any } | null,
): obj is ResourceAccess => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isResourceAccess"');
...
const ServiceDeploymentsConnection_possibleTypes: string[] = [
...
export const isServiceDeploymentsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isServiceDeploymentsConnectionEdge"',
		);
...
export const isServiceDomain = (
	obj?: { __typename?: any } | null,
): obj is ServiceDomain => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isServiceDomain"');
	return ServiceDomain_possibleTypes.includes(obj.__typename);
};

const ServiceInstance_possibleTypes: string[] = ["ServiceInstance"];
export const isServiceInstance = (
	obj?: { __typename?: any } | null,
): obj is ServiceInstance => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isServiceInstance"');
	return ServiceInstance_possibleTypes.includes(obj.__typename);
};

const ServiceRepoTriggersConnection_possibleTypes: string[] = [
...
export const isServiceRepoTriggersConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isServiceRepoTriggersConnectionEdge"',
		);
	return ServiceRepoTriggersConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isServiceServiceInstancesConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isServiceServiceInstancesConnection"',
		);
	return ServiceServiceInstancesConnection_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isServiceServiceInstancesConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isServiceServiceInstancesConnectionEdge"',
		);
	return ServiceServiceInstancesConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};

const ServiceSource_possibleTypes: string[] = ["ServiceSource"];
export const isServiceSource = (
	obj?: { __typename?: any } | null,
): obj is ServiceSource => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isServiceSource"');
...
export const isSimilarTemplate = (
	obj?: { __typename?: any } | null,
): obj is SimilarTemplate => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isSimilarTemplate"');
...
export const isSubscriptionDiscount = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isSubscriptionDiscount"');
...
export const isSubscriptionItem = (
	obj?: { __typename?: any } | null,
): obj is SubscriptionItem => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isSubscriptionItem"');
	return SubscriptionItem_possibleTypes.includes(obj.__typename);
};

const TCPProxy_possibleTypes: string[] = ["TCPProxy"];
export const isTCPProxy = (
	obj?: { __typename?: any } | null,
): obj is TCPProxy => {
...
const TeamCreateAndSubscribeResponse_possibleTypes: string[] = [
...
export const isTeamCreateAndSubscribeResponse = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isTeamCreateAndSubscribeResponse"',
		);
...
export const isTeamMember = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isTeamMember"');
	return TeamMember_possibleTypes.includes(obj.__typename);
};

const TeamPermission_possibleTypes: string[] = ["TeamPermission"];
export const isTeamPermission = (
	obj?: { __typename?: any } | null,
): obj is TeamPermission => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isTeamPermission"');
	return TeamPermission_possibleTypes.includes(obj.__typename);
};

const TeamProjectsConnection_possibleTypes: string[] = [
...
export const isTeamProjectsConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isTeamProjectsConnection"');
	return TeamProjectsConnection_possibleTypes.includes(obj.__typename);
};

const TeamProjectsConnectionEdge_possibleTypes: string[] = [
...
export const isTeamProjectsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isTeamProjectsConnectionEdge"');
...
export const isTeamTrustedDomain = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isTeamTrustedDomain"');
...
export const isTemplateCreator = (
	obj?: { __typename?: any } | null,
): obj is TemplateCreator => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isTemplateCreator"');
...
export const isTemplateDeployPayload = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isTemplateDeployPayload"');
	return TemplateDeployPayload_possibleTypes.includes(obj.__typename);
};

const TemplateGuide_possibleTypes: string[] = ["TemplateGuide"];
export const isTemplateGuide = (
	obj?: { __typename?: any } | null,
): obj is TemplateGuide => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isTemplateGuide"');
	return TemplateGuide_possibleTypes.includes(obj.__typename);
};

const TemplateService_possibleTypes: string[] = ["TemplateService"];
export const isTemplateService = (
	obj?: { __typename?: any } | null,
): obj is TemplateService => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isTemplateService"');
	return TemplateService_possibleTypes.includes(obj.__typename);
};

const TemplateServicesConnection_possibleTypes: string[] = [
...
export const isTemplateServicesConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isTemplateServicesConnection"');
	return TemplateServicesConnection_possibleTypes.includes(obj.__typename);
};

const TemplateServicesConnectionEdge_possibleTypes: string[] = [
...
export const isTemplateServicesConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isTemplateServicesConnectionEdge"',
		);
	return TemplateServicesConnectionEdge_possibleTypes.includes(obj.__typename);
};

const TrustedDomainVerificationData_possibleTypes: string[] = [
...
export const isTwoFactorInfo = (
	obj?: { __typename?: any } | null,
): obj is TwoFactorInfo => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isTwoFactorInfo"');
...
export const isTwoFactorInfoSecret = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isTwoFactorInfoSecret"');
	return TwoFactorInfoSecret_possibleTypes.includes(obj.__typename);
};

const UsageAnomaly_possibleTypes: string[] = ["UsageAnomaly"];
export const isUsageAnomaly = (
	obj?: { __typename?: any } | null,
): obj is UsageAnomaly => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isUsageAnomaly"');
...
export const isUsageLimit = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isUsageLimit"');
...
export const isUserKickbackEarnings = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isUserKickbackEarnings"');
...
export const isUserProfile = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isUserProfile"');
...
export const isUserProfileResponse = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isUserProfileResponse"');
...
export const isUserProfileResponsePublicProjectsConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isUserProfileResponsePublicProjectsConnection"',
		);
	return UserProfileResponsePublicProjectsConnection_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isUserProfileResponsePublicProjectsConnectionEdge = (
	...
	return UserProfileResponsePublicProjectsConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};

const UserProjectsConnection_possibleTypes: string[] = [
...
export const isUserProjectsConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isUserProjectsConnection"');
	return UserProjectsConnection_possibleTypes.includes(obj.__typename);
};

const UserProjectsConnectionEdge_possibleTypes: string[] = [
...
export const isUserProjectsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isUserProjectsConnectionEdge"');
	return UserProjectsConnectionEdge_possibleTypes.includes(obj.__typename);
};

const UserProviderAuthsConnection_possibleTypes: string[] = [
...
const UserProviderAuthsConnectionEdge_possibleTypes: string[] = [
...
export const isUserProviderAuthsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isUserProviderAuthsConnectionEdge"',
		);
...
export const isUserTeamsConnection = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isUserTeamsConnection"');
	return UserTeamsConnection_possibleTypes.includes(obj.__typename);
};

const UserTeamsConnectionEdge_possibleTypes: string[] = [
...
export const isUserTeamsConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isUserTeamsConnectionEdge"');
...
export const isVercelAccount = (
	obj?: { __typename?: any } | null,
): obj is VercelAccount => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isVercelAccount"');
	return VercelAccount_possibleTypes.includes(obj.__typename);
};

const VercelInfo_possibleTypes: string[] = ["VercelInfo"];
export const isVercelInfo = (
	obj?: { __typename?: any } | null,
): obj is VercelInfo => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isVercelInfo"');
	return VercelInfo_possibleTypes.includes(obj.__typename);
};

const VercelProject_possibleTypes: string[] = ["VercelProject"];
export const isVercelProject = (
	obj?: { __typename?: any } | null,
): obj is VercelProject => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isVercelProject"');
...
export const isVolumeInstance = (
	obj?: { __typename?: any } | null,
): obj is VolumeInstance => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isVolumeInstance"');
...
export const isVolumeInstanceBackup = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isVolumeInstanceBackup"');
	return VolumeInstanceBackup_possibleTypes.includes(obj.__typename);
};

const VolumeInstanceBackupSchedule_possibleTypes: string[] = [
	"VolumeInstanceBackupSchedule",
];
...
const VolumeInstanceReplicationProgress_possibleTypes: string[] = [
	"VolumeInstanceReplicationProgress",
];
export const isVolumeInstanceReplicationProgress = (
	obj?: { __typename?: any } | null,
): obj is VolumeInstanceReplicationProgress => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isVolumeInstanceReplicationProgress"',
		);
	return VolumeInstanceReplicationProgress_possibleTypes.includes(
		obj.__typename,
	);
};

const VolumeReplicationProgressUpdate_possibleTypes: string[] = [
	"VolumeReplicationProgressUpdate",
];
export const isVolumeReplicationProgressUpdate = (
	obj?: { __typename?: any } | null,
): obj is VolumeReplicationProgressUpdate => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isVolumeReplicationProgressUpdate"',
		);
	return VolumeReplicationProgressUpdate_possibleTypes.includes(obj.__typename);
};

const VolumeSnapshotReplicationProgressUpdate_possibleTypes: string[] = [
	"VolumeSnapshotReplicationProgressUpdate",
];
export const isVolumeSnapshotReplicationProgressUpdate = (
	obj?: { __typename?: any } | null,
): obj is VolumeSnapshotReplicationProgressUpdate => {
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isVolumeSnapshotReplicationProgressUpdate"',
		);
	return VolumeSnapshotReplicationProgressUpdate_possibleTypes.includes(
		obj.__typename,
	);
};

const VolumeVolumeInstancesConnection_possibleTypes: string[] = [
...
export const isVolumeVolumeInstancesConnection = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isVolumeVolumeInstancesConnection"',
		);
...
export const isVolumeVolumeInstancesConnectionEdge = (
	...
	if (!obj?.__typename)
		throw new Error(
			'__typename is missing in "isVolumeVolumeInstancesConnectionEdge"',
		);
	return VolumeVolumeInstancesConnectionEdge_possibleTypes.includes(
		obj.__typename,
	);
};
...
export const isWithdrawal = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isWithdrawal"');
...
export const isWithdrawalAccount = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isWithdrawalAccount"');
...
export const isWorkflowId = (
	...
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isWorkflowId"');
	return WorkflowId_possibleTypes.includes(obj.__typename);
};

const WorkflowResult_possibleTypes: string[] = ["WorkflowResult"];
export const isWorkflowResult = (
	obj?: { __typename?: any } | null,
): obj is WorkflowResult => {
	if (!obj?.__typename)
		throw new Error('__typename is missing in "isWorkflowResult"');
...
export const enumDnsRecordPurpose = {
	DNS_RECORD_PURPOSE_ACME_DNS01_CHALLENGE:
		"DNS_RECORD_PURPOSE_ACME_DNS01_CHALLENGE" as const,
...
export const enumDnsRecordStatus = {
	...
	DNS_RECORD_STATUS_REQUIRES_UPDATE:
		"DNS_RECORD_STATUS_REQUIRES_UPDATE" as const,
