...
export type ActiveFeatureFlag = 'CEPH_VOLUMES' | 'DEFAULT_TO_RAILPACK' | 'PRIORITY_BOARDING' | 'V3_NEW_PROJECT_PAGE'

export type ActiveServiceFeatureFlag = 'COPY_VOLUME_TO_ENVIRONMENT' | 'NON_DESTRUCTIVE_VOLUME_MIGRATIONS' | 'PLACEHOLDER'
...
export interface MutationGenqlSelection{
    ...
    /** Send an email to welcome a user to our community */
    sendCommunityWelcomeEmail?: { __args: {input: SendCommunityWelcomeEmailInput} }
    /** Send a new bounty question email */
    sendNewBountyEmail?: { __args: {input: SendNewBountyEmailInput} }
    /** Send a question moved to bounty email */
    sendQuestionMovedToBountyEmail?: { __args: {input: SendQuestionMovedToBountyEmailInput} }
    /** Connect a service to a source */
...
export interface QueryGenqlSelection{
    ...
    startDate: Scalars['DateTime'], teamId?: (Scalars['String'] | null), volumeId?: (Scalars['String'] | null), volumeInstanceExternalId?: (Scalars['String'] | null), workspaceId?: (Scalars['String'] | null)} })
...
export interface SendBountyWonEmailInput {bountyAmount: Scalars['Float'],threadTitle: Scalars['String'],threadUrl: Scalars['String'],userId: Scalars['String'],workspaceName: Scalars['String']}
...
export interface SendCommunityWelcomeEmailInput {userId: Scalars['String']}

export interface SendNewBountyEmailInput {threadTitle: Scalars['String'],threadUrl: Scalars['String'],userIds: Scalars['String'][]}

export interface SendQuestionMovedToBountyEmailInput {threadTitle: Scalars['String'],threadUrl: Scalars['String'],userId: Scalars['String']}
...
export interface customerTogglePayoutsToCreditsInput {isWithdrawingToCredits: Scalars['Boolean']}
    ...
    export const isReissuedInvoice = (obj?: { __typename?: any } | null): obj is ReissuedInvoice => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isReissuedInvoice"')
...
export const enumActiveServiceFeatureFlag = {
   ...
   NON_DESTRUCTIVE_VOLUME_MIGRATIONS: 'NON_DESTRUCTIVE_VOLUME_MIGRATIONS' as const,
